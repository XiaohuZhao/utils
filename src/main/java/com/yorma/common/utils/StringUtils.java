...
public class StringUtils {
    ...
    public static String subString(String str, String strStart, String strEnd) {
        ...
        if (strStartIndex < 0) {
            throw new StringIndexOutOfBoundsException("字符串 :---->" + str + "<---- 中不存在 " + strStart + ", 无法截取目标字符串");
        }
        if (strEndIndex < 0) {
            throw new StringIndexOutOfBoundsException("字符串 :---->" + str + "<---- 中不存在 " + strEnd + ", 无法截取目标字符串");
        }
        /* 开始截取 */
